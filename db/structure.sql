...
CREATE VIEW public.cvt1 AS
 SELECT DISTINCT acto.id_caso,
   ...
   FROM (((((((public.sivel2_gen_acto acto
     ...
     LEFT JOIN public.msip_departamento departamento ON ((departamento.id = ubicacion.id_departamento)))
